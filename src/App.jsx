...
export default function App() {
  ...
  return (
    <div className="app-container">
      ...
      {/* Floating Interactive Coupon Ribbon & WhatsApp Bot Launcher */}
      {!hasPurchased ? (
      ...
      {/* Floating WhatsApp Direct Chat Launcher Button */}
      <a 
        className="floating-whatsapp-widget" 
        href="https://wa.me/918469441014?text=Hi%20DAITRA%20Couture%2C%20I%20have%20an%20inquiry"
        target="_blank"
        rel="noopener noreferrer"
        title="Chat with DAITRA Couture on WhatsApp"
      ...
      {/* WhatsApp AI Chatbot Modal Simulator */}

            ...
            {checkoutStep === 'cart' && (
              <div className="cart-items-body">
                ...
                <div className="cart-summary">
                  ...
                  <a 
                    href={`https://wa.me/918469441014?text=${encodeURIComponent(
                      `Hello DAITRA Boutique! I would like to order from my cart:\n\n` + 
                      cartItems.map(i => `• ${i.title} (Size: ${i.selectedSize}, Qty: ${i.quantity}) - ₹${i.price * i.quantity}`).join('\n') + 
